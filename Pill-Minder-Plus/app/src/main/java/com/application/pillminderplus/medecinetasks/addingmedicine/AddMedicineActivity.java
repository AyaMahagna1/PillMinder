...
import com.application.pillminderplus.medecinetasks.addingmedicine.fragments.AddNameFragment;
import com.shuhart.stepview.StepView;

import java.util.ArrayList;

public class AddMedicineActivity extends AppCompatActivity implements AddMedicineView {

    private AddingMedicinePresenter addMedPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addMedPresenter = new AddingMedicinePresenter(this);
    ...
    private void initFragmentsList() {
        ...
        fragments.add(new AddNameFragment());
    }
    ...
    public AddingMedicinePresenter getAddMedPresenter() {
